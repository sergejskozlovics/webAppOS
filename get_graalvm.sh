...
if case $OSTYPE in darwin*) true;; *) false;; esac; then
  # macOS
  SRC_URL=https://github.com/graalvm/graalvm-ce-builds/releases/download/vm-21.1.0/graalvm-ce-java11-darwin-amd64-21.1.0.tar.gz
  PATH_PREFIX=graalvm-ce-java11-21.1.0/Contents/Home
  PATH_PREFIX_LEN=3
else
  # not macOS
  ...
  if [ $OSTYPE = "linux-gnu" ]; then
    ...
    if [ $HOSTTYPE = "x86_64" ]; then
      SRC_URL="https://github.com/graalvm/graalvm-ce-builds/releases/download/vm-21.1.0/graalvm-ce-java11-linux-amd64-21.1.0.tar.gz"
    elif [ $HOSTTYPE = "aarch64" ]; then
      SRC_URL="https\://github.com/graalvm/graalvm-ce-builds/releases/download/vm-21.1.0/graalvm-ce-java11-linux-aarch64-21.1.0.tar.gz"
    else
      echo Unsupported Linux processor architecture $HOSTTYPE.
    fi
    PATH_PREFIX=graalvm-ce-java11-21.1.0
    PATH_PREFIX_LEN=1
  else
