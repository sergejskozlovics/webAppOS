  	...
  	implements RAAPIReferenceWrapper
{
	...
	{
		return factory.raapi.getAttributeValue(rObject, factory.EVENT_INFO);
	}
	public boolean setInfo(String value)
	{
		if (value == null)
			return factory.raapi.deleteAttributeValue(rObject, factory.EVENT_INFO);
		return factory.raapi.setAttributeValue(rObject, factory.EVENT_INFO, value.toString());
	}
}
