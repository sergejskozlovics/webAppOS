  	...
  	implements RAAPIReferenceWrapper
{
	...
	// package-visibility:
	Engine(GraphDiagramEngineMetamodelFactory _factory)
	{
		factory = _factory;
	...
	public Engine(GraphDiagramEngineMetamodelFactory _factory, long _rObject, boolean _takeReference)
	{
		factory = _factory;
		rObject = _rObject;
	...
	public static Iterable<? extends Engine> allObjects(GraphDiagramEngineMetamodelFactory factory)
	{
	...
	public static Engine firstObject(GraphDiagramEngineMetamodelFactory factory)
	{
		long it = factory.raapi.getIteratorForAllClassObjects(factory.ENGINE);
		if (it == 0)
			return null;
