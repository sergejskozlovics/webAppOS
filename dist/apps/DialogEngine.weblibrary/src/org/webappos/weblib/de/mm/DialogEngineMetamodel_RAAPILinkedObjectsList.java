...
class DialogEngineMetamodel_RAAPILinkedObjectsList<E extends RAAPIReferenceWrapper> implements List<E> {

	private DialogEngineMetamodelFactory factory;
	private long rSourceObject;
	private long rAssociationEnd;
	DialogEngineMetamodel_RAAPILinkedObjectsList(DialogEngineMetamodelFactory _factory, long _rSourceObject, long _rAssociationEnd)
	{
		factory = _factory;
