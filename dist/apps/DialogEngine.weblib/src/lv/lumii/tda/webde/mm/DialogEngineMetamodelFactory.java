	...
	public void setRAAPI(RAAPI _raapi, String prefix, boolean insertMetamodel) throws ElementReferenceException // set RAAPI to null to free references
	{
		...
		if (raapi != null) {
			...
			if (insertMetamodel) {
				...
				if (!raapi.isDirectSubClass(D_SHARP_COMMAND, COMMAND))
					if (!raapi.createGeneralization(D_SHARP_COMMAND, COMMAND)) {
						setRAAPI(null, null, false); // freeing references initialized so far...
						throw new ElementReferenceException("Error creating a generalization between classes D_SHARP_Command and TDAKernel::Command.");
					}
				if (!raapi.isDirectSubClass(D_SHARP_EVENT, EVENT))
					if (!raapi.createGeneralization(D_SHARP_EVENT, EVENT)) {
						setRAAPI(null, null, false); // freeing references initialized so far...
						throw new ElementReferenceException("Error creating a generalization between classes D_SHARP_Event and TDAKernel::Event.");
					}
			...
			if ((D_SHARP_EVENTSOURCE_EVENTHANDLER == 0) && insertMetamodel) {
				D_SHARP_EVENTSOURCE_EVENTHANDLER = raapi.createAssociation(D_SHARP_EVENTSOURCE, D_SHARP_EVENTHANDLER, "eventSource", "eventHandler", true);
			}
			if (D_SHARP_EVENTSOURCE_EVENTHANDLER == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_COMPONENT_OWNEDGROUP == 0) && insertMetamodel) {
				D_SHARP_COMPONENT_OWNEDGROUP = raapi.createAssociation(D_SHARP_COMPONENT, D_SHARP_GROUP, "owner", "ownedGroup", true);
			}
			if (D_SHARP_COMPONENT_OWNEDGROUP == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_CONTAINER_COMPONENT == 0) && insertMetamodel) {
				D_SHARP_CONTAINER_COMPONENT = raapi.createAssociation(D_SHARP_CONTAINER, D_SHARP_COMPONENT, "container", "component", true);
			}
			if (D_SHARP_CONTAINER_COMPONENT == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_FORM_OWNEDEVENT == 0) && insertMetamodel) {
				D_SHARP_FORM_OWNEDEVENT = raapi.createAssociation(D_SHARP_FORM, D_SHARP_EVENT, "form", "ownedEvent", true);
			}
			if (D_SHARP_FORM_OWNEDEVENT == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_LISTBOX_ITEM == 0) && insertMetamodel) {
				D_SHARP_LISTBOX_ITEM = raapi.createAssociation(D_SHARP_LISTBOX, D_SHARP_ITEM, "listBox", "item", true);
			}
			if (D_SHARP_LISTBOX_ITEM == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_VTABLETYPE_COLUMN == 0) && insertMetamodel) {
				D_SHARP_VTABLETYPE_COLUMN = raapi.createAssociation(D_SHARP_VTABLETYPE, D_SHARP_VTABLECOLUMNTYPE, "vTableTypeOwner", "column", true);
			}
			if (D_SHARP_VTABLETYPE_COLUMN == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_VTABLETYPE_BUTTON == 0) && insertMetamodel) {
				D_SHARP_VTABLETYPE_BUTTON = raapi.createAssociation(D_SHARP_VTABLETYPE, D_SHARP_BUTTON, "vTableType", "button", true);
			}
			if (D_SHARP_VTABLETYPE_BUTTON == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_VTABLE_VTABLEROW == 0) && insertMetamodel) {
				D_SHARP_VTABLE_VTABLEROW = raapi.createAssociation(D_SHARP_VTABLE, D_SHARP_VTABLEROW, "vTable", "vTableRow", true);
			}
			if (D_SHARP_VTABLE_VTABLEROW == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_VTABLEROW_VTABLECELL == 0) && insertMetamodel) {
				D_SHARP_VTABLEROW_VTABLECELL = raapi.createAssociation(D_SHARP_VTABLEROW, D_SHARP_VTABLECELL, "vTableRow", "vTableCell", true);
			}
			if (D_SHARP_VTABLEROW_VTABLECELL == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_BUTTON_FORMONCLICK == 0) && insertMetamodel) {
				D_SHARP_BUTTON_FORMONCLICK = raapi.createAssociation(D_SHARP_BUTTON, D_SHARP_FORM, "callingButton", "formOnClick", true);
			}
			if (D_SHARP_BUTTON_FORMONCLICK == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_COMBOBOX_ITEM == 0) && insertMetamodel) {
				D_SHARP_COMBOBOX_ITEM = raapi.createAssociation(D_SHARP_COMBOBOX, D_SHARP_ITEM, "comboBox", "item", true);
			}
			if (D_SHARP_COMBOBOX_ITEM == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_TREE_TREENODE == 0) && insertMetamodel) {
				D_SHARP_TREE_TREENODE = raapi.createAssociation(D_SHARP_TREE, D_SHARP_TREENODE, "tree", "treeNode", true);
			}
			if (D_SHARP_TREE_TREENODE == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_MULTILINETEXTBOX_TEXTLINE == 0) && insertMetamodel) {
				D_SHARP_MULTILINETEXTBOX_TEXTLINE = raapi.createAssociation(D_SHARP_MULTILINETEXTBOX, D_SHARP_TEXTLINE, "multiLineTextBox", "textLine", true);
			}
			if (D_SHARP_MULTILINETEXTBOX_TEXTLINE == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_VTABLECOLUMNTYPE_DEFAULTCOMPONENT == 0) && insertMetamodel) {
				D_SHARP_VTABLECOLUMNTYPE_DEFAULTCOMPONENT = raapi.createAssociation(D_SHARP_VTABLECOLUMNTYPE, D_SHARP_TABLECOMPONENT, "vTableColumnTypeOwner", "defaultComponent", true);
			}
			if (D_SHARP_VTABLECOLUMNTYPE_DEFAULTCOMPONENT == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_VTABLECELL_COMPONENT == 0) && insertMetamodel) {
				D_SHARP_VTABLECELL_COMPONENT = raapi.createAssociation(D_SHARP_VTABLECELL, D_SHARP_TABLECOMPONENT, "vTableCellOwner", "component", true);
			}
			if (D_SHARP_VTABLECELL_COMPONENT == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
			...
			if ((D_SHARP_TREENODE_CHILDNODE == 0) && insertMetamodel) {
				D_SHARP_TREENODE_CHILDNODE = raapi.createAssociation(D_SHARP_TREENODE, D_SHARP_TREENODE, "parentNode", "childNode", true);
			}
			if (D_SHARP_TREENODE_CHILDNODE == 0) {
				setRAAPI(null, null, false); // freeing references initialized so far...
