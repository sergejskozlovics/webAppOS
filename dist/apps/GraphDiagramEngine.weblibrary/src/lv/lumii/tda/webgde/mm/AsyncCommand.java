  	...
  	implements RAAPIReferenceWrapper
{
	...
	*/
	...
	// package-visibility:
	AsyncCommand(GraphDiagramEngineMetamodelFactory _factory)
	{
	...
	public AsyncCommand(GraphDiagramEngineMetamodelFactory _factory, long _rObject, boolean _takeReference)
	{
	...
	public static Iterable<? extends AsyncCommand> allObjects(GraphDiagramEngineMetamodelFactory factory)
	{
	...
	public static AsyncCommand firstObject(GraphDiagramEngineMetamodelFactory factory)
	{
		long it = factory.raapi.getIteratorForAllClassObjects(factory.ASYNCCOMMAND);
		if (it == 0)
			return null;
