...
class GraphDiagramEngineMetamodel_RAAPILinkedObjectsList<E extends RAAPIReferenceWrapper> implements List<E> {

	private GraphDiagramEngineMetamodelFactory factory;
	private long rSourceObject;
	private long rAssociationEnd;
	GraphDiagramEngineMetamodel_RAAPILinkedObjectsList(GraphDiagramEngineMetamodelFactory _factory, long _rSourceObject, long _rAssociationEnd)
	{
		factory = _factory;
