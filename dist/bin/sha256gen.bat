...
@rem ##########################################################################
@rem
@rem  sha256gen startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SHA256GEN_OPTS to pass JVM options to this script.
...
@rem Execute sha256gen
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SHA256GEN_OPTS%  -classpath "%CLASSPATH%" org.webappos.util.SHA256Gen %CMD_LINE_ARGS%
...
:fail
rem Set variable SHA256GEN_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%SHA256GEN_EXIT_CONSOLE%" exit 1
exit /b 1
