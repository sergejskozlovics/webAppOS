...
@rem ##########################################################################
@rem
@rem  webappos startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and WEBAPPOS_OPTS to pass JVM options to this script.
set DEFAULT_JVM_OPTS="-Dlog4j.configurationFile=%APP_HOME%\etc\log4j2.properties" "-Dorg.eclipse.jetty.util.log.class=org.eclipse.jetty.util.log.Slf4jLog"
...
:fail
rem Set variable WEBAPPOS_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%WEBAPPOS_EXIT_CONSOLE%" exit 1
exit /b 1
