...
class EnvironmentEngineMetamodel_RAAPILinkedObjectsList<E extends RAAPIReferenceWrapper> implements List<E> {

	private EnvironmentEngineMetamodelFactory factory;
	private long rSourceObject;
	private long rAssociationEnd;
	EnvironmentEngineMetamodel_RAAPILinkedObjectsList(EnvironmentEngineMetamodelFactory _factory, long _rSourceObject, long _rAssociationEnd)
	{
		factory = _factory;
