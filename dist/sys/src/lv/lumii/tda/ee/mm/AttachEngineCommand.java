  	...
  	implements RAAPIReferenceWrapper
{
	...
	*/
	...
	// package-visibility:
	AttachEngineCommand(EnvironmentEngineMetamodelFactory _factory)
	{
	...
	public AttachEngineCommand(EnvironmentEngineMetamodelFactory _factory, long _rObject, boolean _takeReference)
	{
	...
	public static Iterable<? extends AttachEngineCommand> allObjects(EnvironmentEngineMetamodelFactory factory)
	{
	...
	public static AttachEngineCommand firstObject(EnvironmentEngineMetamodelFactory factory)
	{
		long it = factory.raapi.getIteratorForAllClassObjects(factory.ATTACHENGINECOMMAND);
		if (it == 0)
			return null;
