...
public class AppProperties extends SomeProperties {
	...
	public String[] requires_engines = {};
	...
	public AppProperties(String appName, String appDir) {
		super(appName, appDir+File.separator+"app.properties");
		...
		try {
			...
			String _requires_engines = properties.getProperty("requires_engines", "").trim();			
			ArrayList<String> arr = new ArrayList<String>();			
			for (String engineName : _requires_engines.split(",")) {
				if (!engineName.trim().isEmpty())
					arr.add(engineName.trim());
			}
			requires_engines = arr.toArray(new String[] {});
