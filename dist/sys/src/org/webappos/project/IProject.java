...
//	public final static String CLIENT_REPOSITORY = "ar:shmclient"; // used by web processors when connecting to repositories of CloudProjects
	*/
	 ...
	 */
	public boolean open(WebAppProperties appProps, String name, String login, RAAPI_Synchronizer sync, IEventsCommandsHook hook);
	 ...
	 * @return whether the operation succeeded
	 */
	public boolean boostrap(WebAppProperties appProps, String desiredName, String login, RAAPI_Synchronizer sync, IEventsCommandsHook hook);
