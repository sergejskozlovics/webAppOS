...
// Run from the theme dir like:
//
//	$ node compile.js
//	(requies node with less@1.X installed)

var fs = require('fs'),		// file system access
	path = require('path'),	// get directory from file name
	less = require('C:/Users/Sergejs Kozlovics/AppData/Roaming/npm/node_modules/less');	// less processor
//	less = require('/usr/local/lib/node_modules/less');	// less processor
