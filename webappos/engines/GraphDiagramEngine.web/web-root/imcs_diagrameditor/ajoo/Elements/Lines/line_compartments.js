...
LinkCompartments.prototype = {
	...
	create: function(comparts_in) {
		...
		_.each(comparts_in, function(compart_in) {
			...
			//console.log("COMPARTMENT PLACEMENT",placement);
			...
			placement.width = Math.max(placement.width, compart_in.style.width);
	...
	getPlacementByName: function(placement_name) {
		...
		//console.log("get placement by name ", placement_name);
