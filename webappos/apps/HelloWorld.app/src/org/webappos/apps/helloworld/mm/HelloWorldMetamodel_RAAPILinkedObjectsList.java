...
class HelloWorldMetamodel_RAAPILinkedObjectsList<E extends RAAPIReferenceWrapper> implements List<E> {

	private HelloWorldMetamodelFactory factory;
	private long rSourceObject;
	private long rAssociationEnd;
	HelloWorldMetamodel_RAAPILinkedObjectsList(HelloWorldMetamodelFactory _factory, long _rSourceObject, long _rAssociationEnd)
	{
		factory = _factory;
