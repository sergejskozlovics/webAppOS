...
class SampleMetamodel_RAAPILinkedObjectsList<E extends RAAPIReferenceWrapper> implements List<E> {

	private SampleMetamodelFactory factory;
	private long rSourceObject;
	private long rAssociationEnd;
	SampleMetamodel_RAAPILinkedObjectsList(SampleMetamodelFactory _factory, long _rSourceObject, long _rAssociationEnd)
	{
		factory = _factory;
