...
public class BridgeEventsCommandsHook implements IEventsCommandsHook {
	...
	{
		File mmd = new File(ConfigStatic.ENGINES_DIR+File.separator+engineName+".web"+File.separator+engineName+".mmd");
		if (!mmd.exists())
			mmd = new File(ConfigStatic.ENGINES_DIR+File.separator+engineName+".web"+File.separator+engineName+"Metamodel.mmd");
		if (!mmd.exists())
			mmd = new File(ConfigStatic.ENGINES_DIR+File.separator+engineName+".web"+File.separator+engineName+".ecore");
		if (!mmd.exists())
			mmd = new File(ConfigStatic.ENGINES_DIR+File.separator+engineName+".web"+File.separator+engineName+"Metamodel.ecore");
