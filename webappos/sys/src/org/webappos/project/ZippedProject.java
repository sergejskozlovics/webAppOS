...
public class ZippedProject implements IProject {
	...
	public static boolean validateProjectFolder(String folder, String filename, AppProperties appProps) {
		try {
	...
	@Override
	public boolean open(AppProperties _appProps, String filename, String login, RAAPI_Synchronizer sync, IEventsCommandsHook hook) {
		if (zipFolder != null) {
		...
		if (legacyProject) {
			...
			if (!toolName.endsWith(".app"))
					toolName += ".app";
			appProps = API.propertiesManager.getAppPropertiesByFullName(toolName);
		}
		else {
			if (appProps == null)
				return false;
	...
	@Override
	public boolean createFromTemplate(AppProperties _appProps, String template, String desiredName, String login, RAAPI_Synchronizer sync, IEventsCommandsHook hook) {
		if (zipFolder != null) {
			return false; // already open
		}
	...
	@Override
	public boolean boostrap(AppProperties _appProps, String desiredName, String login, RAAPI_Synchronizer sync, IEventsCommandsHook hook) {		
