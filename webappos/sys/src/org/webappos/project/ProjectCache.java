...
public class ProjectCache {
	...
	private static String downloadUnzipValidate(String project_id, AppProperties appProps, String uuid, boolean create) {		
		if (appProps == null)
			return null;
	...
	public static String getCloudProjectCacheDirectory(String project_id, AppProperties appProps) {
	 ...
	 */
	public static String getCloudProjectCacheDirectory(String project_id, AppProperties appProps, boolean create) {		
